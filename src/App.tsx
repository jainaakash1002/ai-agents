...
function App() {
  ...
  const [selectedRole, setSelectedRole] = useLocalStorage<AIRole | null>('selected-ai-role', null);
  const [generationConfig, setGenerationConfig] = useLocalStorage<GenerationConfig>(
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 flex">
        <div className={`flex-1 transition-all duration-300 ${showSettings ? 'pr-80' : ''}`}>
          <ChatInterface 
            apiKey={apiKey} 
